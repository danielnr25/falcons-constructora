  ...
  return (
   ...
   <div className="flex flex-col sm:flex-row  items-center gap-6">
     <p className="mt-1 max-w-5xl text-[17px] leading-7 text-gray-800 md:text-lg sm:leading-8 text-justify md:px-3">
       Especialistas en ofrecer soluciones integrales para todo tipo de proyectos inmobiliarios. Contamos con un equipo altamente cualificado con capacidad para atenderle en cualquier aspecto relacionado con los proyectos de construcción. Constructora Oviedo es mucho más que una simple empresa constructora.
     </p>
