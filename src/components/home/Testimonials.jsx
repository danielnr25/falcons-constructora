      ...
      <div className="px-6  pt-10 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="flex space-x-4 items-center justify-center">
            ...
            <h2 className="text-4xl font-circular-medium text-blue-900 tracking-tight sm:text-5xl">
              Resultados reales.
            </h2>
          </div>
          <p className="mt-6 text-lg leading-8 text-gray-700">
          La satisfacción del cliente es nuestra máxima prioridad. Trabajamos estrechamente con nuestros clientes para comprender sus necesidades y objetivos específicos, adaptando nuestros servicios para garantizar la entrega puntual y dentro del presupuesto acordado. 
          </p>
        </div>
      </div>
