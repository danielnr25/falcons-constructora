      ...
      <div className="px-6 py-20 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-gray-800">
            Somos una empresa constructora en Piura, fuertemente implicada en el
            crecimiento y el desarrollo social del Perú, mediante la supervisión
            y ejecución de proyectos de construcción reconocidos por su calidad
