      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {data.map((item) => (
          ...
          >
            ...
            />
            <div className="p-6">
              <h2 className="text-xl font-circular-medium tracking-wide text-blue-900 md:text-2xl lg:text-start text-center">
                {item.title}
              </h2>
              <p className="mt-2 leading-6 text-gray-800 text-justify">
                {item.description}
              </p>
