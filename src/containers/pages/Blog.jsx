  ...
  return (
    <Layout>
      <div className="lg:py-10 space-y-12 bg-slate-100">
        <h1 className="text-center text-black font-circular-medium tracking-wider md:text-3xl text-2xl my-5">
          Nuestros blog de noticias
        </h1>
        <div className="flex justify-between lg:px-10 px-4 items-center">
          <h1 className="text-black text-xl font-circular-medium md:text-2xl">
